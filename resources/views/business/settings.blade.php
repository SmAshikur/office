        ...
        <div class="col-xs-12 pos-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center">Terms & Condition</a>
                    <a href="#" class="list-group-item text-center">Vehicle Service & Warranty</a>
                    <a href="#" class="list-group-item text-center">Vehicle Loaction</a>
                    <a href="#" class="list-group-item text-center">Cost Type Vehicle Purchase & Sale</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                <!-- tab 1 end -->
                 @include('business.partials.terms')
                <!-- tab 2 start -->
                <!-- tab 2 end -->
                @include('business.partials.vehicle_service')
                <!-- tab 2 end -->
                @include('business.partials.vehicle_loaction')
                <!-- tab 2 start -->
                 <!-- tab 2 end -->
                @include('business.partials.cost_type')
                <!-- tab 2 start -->
