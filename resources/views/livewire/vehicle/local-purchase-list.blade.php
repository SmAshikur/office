                        ...
                        <tbody>
                            ...
                            @forelse ($purchases as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->chassis_id }}
                                        @if ($item->source_of_product == 'Pre Order')
                                            <div class="highlight">
                                                <i class="fas fa-check-circle highlight__text"
                                                    @if ($item->sale_status == 'Sold') style="color:green"
                                                @else
                                                    style="color:yellow" @endif></i>
                                                <div class="highlight__tooltip">
                                                    <h5 class="text-white">Pre-order /
                                                        Booked</h5>
                                                    <p><strong>Customer
                                                            Name:</strong>{{ $item->pre_order->customer->name ?? '' }}
                                                    </p>
                                                    <p><strong>Phone
                                                            :</strong>{{ $item->pre_order->customer->mobile ?? '' }}
                                                    </p>
                                                </div>
                                            </div>
                                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    Only
                                    <input type="radio" name="purchase_mode" wire:model.defer="purchase_mode"
                                        value="Transfer Only"> Transfer Only
                                    @error('purchase_mode')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label for="vehicle_condition">Vehicle Condition <sup
                                            class="text-danger">*</sup></label>
                                    <br>
                                    @if ($vehicle_type == 'Passenger' || $vehicle_type == 'Commercial')
                                                    ...
                                                    @forelse($pre_orders as $pre_order)
                                                        <tr>
                                                            ...
                                                            <td><input type="radio" name="pre_order_id"
                                                                    ...
                                                                    value="{{ $pre_order->id }}">
                                                                <button class="btn btn-success btn-sm">Pre Order
                                                                    Details</button>
                                                            </td>
                                                        </tr>
                                                    @empty
                            ...
                            @else
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="chassis_id">
                                            @if ($vehicle_condition == 'Used')
                                                <input type="radio" style="height:10px"
                                                    wire:model.defer="tracking_field_name" name="tracking_field_name"
                                                    value="chassis_no">
                                                <span>
                                                    Vin/Chassis No
                                                </span>
                                        ...
                                        <input type="text" wire:model.defer="chassis_id" class="form-control"
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select wire:model.defer="registration_year" id="registration_year"
                                                ...
                                                @foreach (array_reverse(range(1950, 2024)) as $year)
                                ...
                                @if (
                                    ($vehicle_type == 'Passenger' && $vehicle_condition == 'Recondition') ||
                                        ($vehicle_type == 'Passenger' && $vehicle_condition == 'Brand New'))
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                        <div class="form-group">
                        ...
                        @if ($pre_order_show != true)
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <span class="text-muted">Other costs related to vehicle</span>
