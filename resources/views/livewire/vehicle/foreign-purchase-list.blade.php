                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->chassis_id }}
                                        @if ($item->source_of_product == 'Pre Order')
                                            <div class="highlight">
                                                <i class="fas fa-check-circle highlight__text"></i>
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Update Foregin Purchase</h3>
                                                    ...
                                                    @forelse($pre_orders as $pre_order)
                                                        <tr>
                                                            ...
                                                            <td><input type="radio" name="pre_order_id"
                                                                    ...
                                                                    value="{{ $pre_order->id }}">
                                                                <button class="btn btn-sm btn-success">Pre Order
                                                                    Details</button>
                                                            </td>
                                                        </tr>
                                                    @empty
                                ...
                                <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <div style="display: flex">
                                        <input type="number" class="form-control mb-5"
                                            placeholder="Foregin Currency" wire:model.defer="foregin_currency"
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
                                            <div class="form-group">
                                                ...
                                                <input type="radio" wire:model="vehicle_location_type"
                                                    value="overseas" required><span
                                                    style="font-size:13px">Overseas</span>
                                                <input type="radio" wire:model="vehicle_location_type"
                                                    value="transit" required><span
                                                    style="font-size:13px">Transit</span>
                                                <input type="radio" wire:model="vehicle_location_type"
                                                    value="port" required><span style="font-size:13px">Port</span>
                                                <input type="radio" wire:model="vehicle_location_type"
                                                    value="showroom" required><span
                                                    style="font-size:13px">Showroom</span>
                                                <input type="radio" wire:model="vehicle_location_type"
                                                    value="others" required><span style="font-size:13px">Others</span>
                                            </div>
                                            <div class="form-group">
