...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
                    ...
                    function ($sub) {
                        ...
                        if (auth()->user()->can('category.view') || auth()->user()->can('category.create')) {
                            $sub->url(
                                ...
                                ('Add Spare Part/Service Category'),
            ...
            //Vehicle Setup Dropdown
            $menu->dropdown(
                'Vehicle Setup',
                function ($sub) {

                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'manufacture']),
                        'Vehicle Manufacture',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'manufacture']
                    );

                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'model']),
                        'Vehicle Model',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'model']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'bodyType']),
                        'Vehicle Type/Body Type',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'body-type']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'chassisCode']),
                        'Chassis Code',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'chassis-code']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'packageTrimVariant']),
                        'Package/Trim/Variant',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'package-trim-variant']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'displacementEngningCc']),
                        'Displacement /Engine CC',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'displacement-engine-cc']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'tyreSize']),
                        'Tyre Size',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'tyre-size']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'interiorColor']),
                        'Interior Color',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'interior-color']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'exteriorColor']),
                        'Exterior Color',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'exterior-color']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'modelOrigin']),
                        'Model Origin',
                        ['icon' => 'fa fas fa-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'model-origin']
                    );
                },
                ['icon' => 'fa fas fa-cubes', 'id' => 'tour_step5']
            )->order(20);

            //Vehicle Product Dropdown
            $menu->dropdown(
                'Vehicle Product',
                function ($sub) {

                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'addBike']),
                        'Add Bike',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'manufacture']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'bikeList']),
                        'Bike List',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'manufacture']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'addCommercialVehicle']),
                        'Add Commercial Vehicle',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'manufacture']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'commercialVehicleList']),
                        'Commercial Vehicle List',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'manufacture']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'addPassengerVehicle']),
                        'Add Passenger Vehicle',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'manufacture']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'passengerVehicleList']),
            ...
            $menu->dropdown(
                ...
                function ($sub) {
                    ...
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'vehiclePreOrder']),
                        'Add Pre Order',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'vehicle-pre-order']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'vehiclePreOrderList']),
                        'Pre Order List',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'vehicle-pre-order-list']
                    );
                },
                ['icon' => 'fa fas fa-cubes', 'id' => 'tour_step5']
            )->order(20);
            ...
            $menu->dropdown(
                ...
                function ($sub) {
                    ...
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'vehicleLocalPurchase']),
                        'Add Local Purchase',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'local-purchase']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'vehicleLocalPurchaseList']),
                        'Local Purchase List',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'local-purchase-list']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'vehicleForeignPurchase']),
                        'Add Foreign Purchase',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'foreign-purchase']
                    );
                    $sub->url(
                        action([\App\Http\Controllers\VehicleController::class, 'vehicleForeignPurchaseList']),
                        'Foreign Purchase List',
                        ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'vehicle' && request()->segment(2) == 'foreign-purchase-list']
                    );
                },
                ['icon' => 'fa fas fa-cubes', 'id' => 'tour_step5']
            )->order(20);
                    ...
                    function ($sub) use ($enabled_modules) {
                        if (auth()->user()->can('business_settings.access')) {
                            $sub->url(
                              ...
                              $sub->url(
                                action([\App\Http\Controllers\BusinessController::class, 'getImportSettings']),
                               ' Import Settings',
                                ['icon' => 'fa fas fa-file-import', 'active' => request()->segment(1) == 'business', 'id' => 'tour_step2']
                            );
