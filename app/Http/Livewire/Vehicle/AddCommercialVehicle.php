...
class AddCommercialVehicle extends Component
{
    public $product_category, $vehicle_manufacture_id, $fuel_type, $loading_capacity,  $body_type_id, $number_of_wheels, $vehicle_model_id, $model_origin_id, $chassis_code_id, $displacement_engine_cc_id, $transmission, $drive_system;
    ...
    {
        return view('livewire.vehicle.add-commercial-vehicle', [
    ...
    public function store()
    {
        ...
        $this->dispatchBrowserEvent('success', ['msg' => 'Commercial Vehicle Added Successfully']);
        return redirect()->route('vehicle.list.commercial.vehicle');
    }
