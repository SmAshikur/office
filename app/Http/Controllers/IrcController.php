       ...
       if (request()->ajax()) {
            ...
            return Datatables::of($unit)
                ->addColumn(
                    ...
                    [$id])}}" data-id="{{ $id }}" class="btn btn-xs btn-primary edit_terms_button" id="edit_irc_button"><i class="glyphicon glyphicon-edit"></i> 
                    ...
                    @can("terms.delete")
                        ...
                        [$id])}}"  data-id="{{ $id }}" class="btn btn-xs btn-danger delete_terms_button" id="delete_irc_button"><i class="glyphicon glyphicon-trash"></i> 
                       </span>
                    @endcan'
                )
        ...
        return view('bimport.partials.irc');
    }
    public function store(Request $request)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                $terms->number = $input['number'];
                $terms->save();
                $output = [
                    'success' => true,
                    'msg' => 'New Irc Added Successfully',
                ];
            } catch (\Exception $e) {
