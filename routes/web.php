...
use App\Http\Controllers\VehicleSellController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    // Vechicle Route Start
    Route::prefix('vehicle')->as('vehicle.')->group(function () {

        Route::get('manufacture', [VehicleController::class, 'manufacture'])->name('manufacture');
        Route::get('model', [VehicleController::class, 'model'])->name('model');
        Route::get('body-type', [VehicleController::class, 'bodyType'])->name('body.type');
        Route::get('chassis-code', [VehicleController::class, 'chassisCode'])->name('chassis.code');
        Route::get('package-trim-variant', [VehicleController::class, 'packageTrimVariant'])->name('package.trim.variant');
        Route::get('displacement-engine-cc', [VehicleController::class, 'displacementEngningCc'])->name('displacement.engine.css');
        Route::get('tyre-size', [VehicleController::class, 'tyreSize'])->name('tyre.size');
        Route::get('interior-color', [VehicleController::class, 'interiorColor'])->name('interior.color');
        Route::get('exterior-color', [VehicleController::class, 'exteriorColor'])->name('exterior.color');
        Route::get('model-origin', [VehicleController::class, 'modelOrigin'])->name('model.origin');

        //Vehicle Product Add
        Route::get('add-bike', [VehicleController::class, 'addBike'])->name('add.bike');
        Route::get('bike-list', [VehicleController::class, 'bikeList'])->name('list.bike');

        Route::get('add-commercial-vehicle', [VehicleController::class, 'addCommercialVehicle'])->name('add.commercial.vehicle');
        Route::get('commercial-vehicle-list', [VehicleController::class, 'commercialVehicleList'])->name('list.commercial.vehicle');

        Route::get('add-passenger-vehicle', [VehicleController::class, 'addPassengerVehicle'])->name('add.passenger.vehicle');
        Route::get('passenger-vehicle-list', [VehicleController::class, 'passengerVehicleList'])->name('list.passenger.vehicle');
        //Vehicle Pre Order
        Route::get('pre-order', [VehicleController::class, 'vehiclePreOrder'])->name('pre.order');
        Route::get('pre-order-list', [VehicleController::class, 'vehiclePreOrderList'])->name('pre.order.list');

        //Vehicle Purchase
        Route::get('local-purchase', [VehicleController::class, 'vehicleLocalPurchase'])->name('local.purchase');
        Route::get('local-purchase-list', [VehicleController::class, 'vehicleLocalPurchaseList'])->name('local.purchase.list');
        Route::get('foreign-purchase', [VehicleController::class, 'vehicleForeignPurchase'])->name('foreign.purchase');
        Route::get('foreign-purchase-list', [VehicleController::class, 'vehicleForeignPurchaseList'])->name('foreign.purchase.list');
    });
    // Vechicle Route End
