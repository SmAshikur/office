$(document).ready(function () {
    ...
    $('select#vehicle_id').select2({
        ajax: {
            url: '/vehicles/products',
            dataType: 'json',
            delay: 250,
            data: function (params) {
                return {
        ...
        templateResult: function (data) {
          //  console.log(data)
            // alert(data.text)
            //var name = $('#vehicle_id').data('select2').dropdown.$search.val();
            //alert(name)
            var template = '';
            // if (data.vehicle) {
            //     if (data.vehicle.manufacture) {
            //         template += data.vehicle.manufacture.name + " - ";
            //     }
            //     if (data.vehicle.model_origin) {
            //         template += data.vehicle.model_origin.model + "( ";
            //     } else { template += "( "; }
            //     if (data.vehicle.chassis_code) {
            //         template += data.vehicle.chassis_code.name
            //     }
            //     if (data.vehicle.displacement_engine) {
            //         template += data.vehicle.displacement_engine.cc + " - cc ";
            //     }
            //     if (data.vehicle.transmission) {
            //         template += data.vehicle.transmission + ", ";
            //     }
            //     if (data.vehicle.drive_system) {
            //         template += data.vehicle.drive_system + ", ";
            //     }
            //     if (data.vehicle.fuel_type) {
            //         template += data.vehicle.fuel_type + " ) ";
            //     }
            //     if (data.vehicle.year_of_manufacture) {
            //         template += " - " + data.vehicle.year_of_manufacture;
            //     }
            // }
            if(data.text){
                template += data.text ;
            ...
            // Ensure that your data structure matches this expectation
        },
        minimumInputLength: 1,
        language: {
            noResults: function () {
                ...
                return (
                    '<button type="button" data-name="' +
                    name +
                    '" class="btn btn-link add_new_vehicle"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i>&nbsp; Add as new vehicle: ' +
                    name +
                    '</button>'
                );
            },
    ...
    $('#vehicle_id').on('select2:select', function (e) {
        ...
        var selectedText = e.params.data.type; // Get the selected text
